...
export default class Correct extends DefaultScene {
  ...
  public descriptionScene =
      ...
      ' Что-то негромко щелкнуло. Пирамида мелко затряслась, и на вас посыпался песок с потолка.<br>' +
      ...
      ' Вы вернулись в лагерь, чтобы собрать свои вещи.<br>' +
      ' <br>' +
      ...
      ' Вы ничего не теряете в любом случае, и можете заработать.<br>' +
