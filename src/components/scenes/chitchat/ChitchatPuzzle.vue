...
export default class ChitchatPuzzle extends DefaultScene {
  ...
  private problem =
      ...
      ` Если нет - то с вас ${this.bet}. Слушайте загадку.<br>` +
      ' <br>' +
      ...
      ' а тут, как на зло, подвернулся ему Этот - бог письменности, зашедший за перьями для письма.<br>' +
      ' - Что это такое?!! - спросил грозно Обсирис.<br>' +
      ' - Это? Всего лишь завтрак одной из наших зверушек, - рассеянно ответил Этот и вышел из конюшен.<br>' +
  ...
  private fail = ' - Ха-ха-ха. А вот и не правильно. Это был бык.<br>' +
      ' - А почему именно бык?<br>' +
      ' - Во-первых, только быки делают лепешки. Во-вторых, все остальные звери несъедобны или слишком малы для пира.' +
      ' В-третьих: правильный ответ был написан на свитке с загадкой.<br>' +
      ' - Тогда давайте и я загадаю загадку: что с вами будет, если ретрактором по голове?<br>' +
  ...
  private descSuccess =
      ...
      ' Так что это был завтрак именно быка, только уже в сильно переваренном виде - коровья лепешка, так сказать.<br>' +
      ' - Но как же...<br>' +
      ' - Советую изучать энтомологию - иногда бывает полезно.<br>' +
      ' <br>' +
